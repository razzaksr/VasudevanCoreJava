...
/*
List : duplicates allowed, positions, order same as inserted
Set  : no duplicates, no positions, order not same as inserted
    HashSet >> random order of traverse
    TreeSet >> ascending order of traverse
        add, addAll
        contains
        remove(obj)
